...
<!--**********************************
            Nav header start
        ***********************************-->
<div class="nav-header" use:links>
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                <li class="dropdown-item">
                                    <i
                                        class="fa fa-user-circle text-primary me-2"
                                    /> View profile
                                </li>
                                <li class="dropdown-item">
                                    <i class="fa fa-users text-primary me-2" /> Add
                                    to btn-close friends
                                </li>
                                <li class="dropdown-item">
                                    <i class="fa fa-plus text-primary me-2" /> Add
                                    to group
                                </li>
                                <li class="dropdown-item">
                                    <i class="fa fa-ban text-primary me-2" /> Block
                                </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                <button type="button" class="btn btn-primary"
                                    ><i class="fa fa-location-arrow" /></button
                                >
                            </div>
                        </div>
                    </div>
                        ...
                        <ul class="contacts">
                            ...
                            <li>
                                <div class="d-flex bd-highlight">
                                    <div class="user_info">
                                        <span
                                            >Youtube, a video-sharing website..</span
                                        >
                                        <p>10 Aug 2020</p>
                                    </div>
                                    <div class="ms-auto">
                ...
                <div class="header-left">
                    <!-- <div class="me-5 agenda">
                        <a href="javascript:void(0);" class="btn btn-primary"
                            ><i class="fas fa-calendar" />GOLD</a
                        >
                    </div> -->
                    <!-- Buscador -->
                    <!-- <div class="nav-item">
                        <div class="input-group search-area">
                            ...
                            <span class="input-group-text"
                                ><i class="flaticon-381-search-2" /></span
                            >
                        </div>
                    </div> -->
                </div>
                <ul class="navbar-nav header-right">
                            ...
                            >
                                <ul class="timeline">
                                    ...
                                    <li>
                                        <div class="timeline-panel">
                                            <div
                                                class="media me-2 media-success"
                                            >
                                                <i class="fa fa-home" />
                                            </div>
                                            <div class="media-body">
                                    ...
                                    <li>
                                        <div class="timeline-panel">
                                            <div
                                                class="media me-2 media-primary"
                                            >
                                                <i class="fa fa-home" />
                                            </div>
                                            <div class="media-body">
                                ...
                                <ul class="timeline">
                                    ...
                                    <li>
                                        ...
                                        >
                                            ...
                                            <h6 class="mb-0">
                                                john just buy your product <strong
                                                    class="text-warning"
                                                    >Sell $250</strong
                                                >
                                            </h6>
                    ...
                    <li class="nav-item dropdown notification_dropdown">
                        ...
                        >
                            ...
                            <span
                                class="badge light text-white bg-orange rounded-circle"
                                >76</span
                            >
                        </a>
                    </li> -->
                        ...
                        >
                            <div class="header-info me-3">
                                ...
                                <small class="text-end fs-14 font-w400"
                                    ><span
                                        class="__cf_email__"
                                        data-cfemail="20524f424552544f4341524c4f5a604d41494c0e434f4d"
                                        >{userdos.rol}</span
                                    ></small
                                >
                            </div>
...
<!--**********************************
            Sidebar start
        ***********************************-->
<div class="deznav" use:links>
    <div class="deznav-scroll">
        <ul class="metismenu" id="menu">
            {#if userdos.rol == "Administrador"}
                <li>
                    ...
                    <a
                        ...
                        aria-expanded="false"
                    >
                        <i class="fi fi-br-address-book" />
                        <span class="nav-text">Usuarios</span>
                    </a>
                    <ul aria-expanded="false">
                        <li><a href="/usuario">Usuario</a></li>
                        <li><a href="/cliente">Registro cliente</a></li>
                    </ul>
                </li>
                <li>
                    <a href="/buscar" class="" aria-expanded="false">
                        <i class="flaticon-381-search-2" />
                        <span class="nav-text">Buscar</span>
                    </a>
                </li>
                <li>
                    <a href="/reporte-compra" class="" aria-expanded="false">
                        <i class="fa fa-bar-chart" aria-hidden="true" />
                        <span class="nav-text">Reporte compra</span>
                    </a>
                </li>
                <li>
                    <a href="/reporte-venta" class="" aria-expanded="false">
                        <i class="fa fa-area-chart" aria-hidden="true" />
                        <span class="nav-text">Reporte Venta</span>
                    </a>
                </li>
                <li>
                    <a href="/reporte" class="" aria-expanded="false">
            ...
            {#if userdos.rol == "Administrador" || userdos.rol == "Invitado"}
                <li>
                    ...
                    <a
                        ...
                        aria-expanded="false"
                    >
                        <i class="flaticon-025-dashboard" />
            ...
            {/if}
            {#if userdos.rol == "Administrador" || userdos.rol == "Asistente"}
                <li>
                    <a href="/caja-chica" class="" aria-expanded="false">
        ...
        <div class="copyright">
            <p>
                <strong>Mantenimiento</strong> © 2024 - Svelte
            </p>
        </div>
    </div>
</div>
