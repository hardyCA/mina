<script>
    ...
    const seleccionarCliente = async () => {
        ...
        datos = await buscarClienteFirebasedos(
            id_cliente,
            fechadesde,
            fechaasta
        );
                        ...
                        <tbody>
                            {#each datos as r}
                                <tr>
                                    ...
                                    <td>{r.totalOnza}</td>
                                    <td>{r.saldo}</td>
                                    <td>{r.saldo * r.tipoCambio}</td>
                                    <td>{r.anticipo}</td>
                                    <td>{r.anticipo * r.tipoCambio}</td>
                                    <td class="table-info">{r.montoTotal}</td>
                                    <td class="table-info"
                                        >{r.montoTotal * r.tipoCambio}</td
                                    >
                                    <td class="color-primary">
                                        <button
                            ...
                            <tr>
                                ...
                                >
                                <td class="table-dark"
                                    >{myRound(totalSaldodosBSTT(datos))}
                                </td>
                                <td class="table-dark"
                                    >{totalAnticipodosTT(datos)}</td
                                >
                                <td class="table-dark"
                                    >{totalAnticipodosBSTT(datos)}
                                </td>
                                <td class="table-dark"
                                    >{myRound(totalTotaldosTT(datos))}</td
                                >
                                <td class="table-dark"
                                    >{myRound(totalTotaldosBSTT(datos))}
                                </td>
                                <td />
                            </tr>
                            <!-- <tr>
